...
public class ListroomController implements Initializable {
    ...
    public void LogoutBtn() throws IOException
    {
        ...
        LogggController Controller;
        mainPane.getChildren().add(nodes.get(0));
            
        
        Controller = loaders.get(0).getController();
        Controller.setMainPane(mainPane);
        //Controller.setSocket(this.Sockclient);

        loaders.get(0).setController(Controller);
    }
